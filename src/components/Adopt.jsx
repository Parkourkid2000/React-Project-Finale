  ...
  return (
    <section id="Adopt" className="bg-color1 rounded-s-[100px] xl:ml-20 mb-40">
      ...
      <div className="mb-20 rounded-[50px] relative flex  max-w-xl justify-center items-center">
          ...
          <div className="bg-color2 cursor-pointer hover:bg-color4 text  text-4xl max-w-xl font-bold flex items-center justify-center h-20 rounded-b-[50px] absolute bottom-[-30px] w-full">
            <button className="text-light">See our Collies</button>
          </div>
        </div>
        <div className="mb-20 rounded-[50px] relative  flex max-w-xl justify-center items-center">
          <img src={Collie3} className="w-[500px] max-w-[90vw] rounded-[50px]" alt="" />
          <div className="bg-color2  cursor-pointer hover:bg-color4 text-4xl max-w-xl font-bold flex items-center justify-center h-20 rounded-b-[50px] absolute bottom-[-30px] w-full">
            <button className="text-light">See our Collies</button>
          </div>
        </div>
      ...
      <div className="md:text-center flex justify-around max-sm:flex-col max-sm:text-center md:flex-col items-center pb-16">
        <div>
          ...
          <p className="text-lg md:text-2xl xl:text-3xl pb-6">FILL OUT AN ADOPTION FORM!</p>
        </div>
        <div className="">
          <button className="bg-color2 hover:bg-color4 text-light rounded-full px-12 py-4 font-bold text-lg
          md:text-2xl xl:text-3xl md:w-72 xl:w-96">
            Get Started
          </button>
        </div>
      </div>
